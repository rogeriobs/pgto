  ...
  <form id="frmCalculaPGTO" onsubmit="return false;">
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        ...
        <td><input name="txt_entrada" type="text" id="txt_entrada" onkeydown="formatamoeda(this,retornaKeyCode(event),2)" onkeyup="formatamoeda(this,retornaKeyCode(event),2)" value="0,00" maxlength="15" /></td>
      </tr>
      <tr>
